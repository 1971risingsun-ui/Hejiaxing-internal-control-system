                  ...
                  <div className="bg-white p-3 rounded-lg border border-slate-200 shadow-sm flex flex-col justify-center">
                      {activeReport ? (
                          <div className="flex items-center justify-between h-full">
                              <div>
                                  <label className="block text-[10px] font-bold text-slate-400 uppercase tracking-widest mb-1">上傳日期</label>
                              ...
                              <button 
                                  ...
                                  className="flex items-center gap-1 px-3 py-2 bg-slate-50 border border-slate-200 rounded-xl text-xs font-bold text-slate-500 hover:text-red-500 hover:bg-red-50 transition-all active:scale-95"
                                  title="刪除此報價單"
                              >
                          ...
                          <div className="flex flex-col justify-center h-full">
                              <label className="block text-xs font-semibold text-slate-500 mb-1 uppercase tracking-wider">建立日期</label>
                              <input 
                                  type="date" 
                                  value={reportDate}
                                  onChange={e => setReportDate(e.target.value)}
                                  className="w-full px-3 py-2 border border-slate-200 rounded-lg text-sm bg-white font-bold outline-none focus:ring-2 focus:ring-indigo-500"
                              />
                          </div>
                      )}
                  </div>
